...
OUTPUT_DIRECTORY = "/Path/to/directory"  # Update this with the desired directory path

# Define API endpoints
API_ENDPOINTS = [
    "https://api.recordedfuture.com/v2/ip/demoevents?limit=500",
    "https://api.recordedfuture.com/v2/hash/demoevents?limit=500",
    "https://api.recordedfuture.com/v2/domain/demoevents?limit=500",
    "https://api.recordedfuture.com/v2/url/demoevents?limit=500",
    "https://api.recordedfuture.com/v2/vulnerability/demoevents?limit=500"
]
...
inputs_conf_path = os.path.join(OUTPUT_DIRECTORY, "inputs.conf")
